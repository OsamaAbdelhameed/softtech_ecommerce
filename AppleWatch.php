...
<head>
  <title>
    Apple Watch Series6 details</title>
...
<body>
  <div id="main_container">
    ...
    <div id="header">
      ...
      <div class="oferte_content">
        ...
        <div class="oferta">
          ...
          <div class="oferta_content"> <img src="images/p2.gif" alt="" border="0" width="90" height="92" class="oferta_img" />
            <div class="oferta_details">
              <div class="oferta_title">
                Apple Watch Series 6 (GPS, 44mm) - Space Grey Aluminium Case with Black Sport Band</div>
              <div class="oferta_text">
                Apple Watch Series 6 (GPS, 44mm) - Space Grey Aluminium Case with Black Sport Band, 5GHz Wi-Fi and U1 Ultra Wideband chip, Track your daily activity on Apple Watch, Swimproof design.</div>
              <a href="AppleWatch.php" class="details"> &nbsp Refresh</a>
            </div>
          </div>
          <div class="oferta_pagination"> <a href="AppleWatch.php"><span class="current">1</span></a> <a href="#">2</a> <a href="#">3</a> <a href="#">4</a> <a href="#">5</a> </div>
        </div>
        <div class="top_divider"><img src="images/header_divider.png" alt="" width="1" height="164" /></div>
      </div>
    ...
    <div id="main_content">
      ...
      <!-- end of menu tab -->
      <!-- nav -->
      <div class="crumb_navigation"> Navigation: <a href="index.php">Home</a> &lt; <span class="current">Electronic Accessories &lt; Apple Watch Series 6</span> </div>
      ...
      <div class="center_content">
        <div class="center_title_bar">Apple Watch Series 6 (GPS, 44mm) - Space Grey Aluminium Case with Black Sport Band</div>
        <div class="prod_box_big">
          <div class="top_prod_box_big"></div>
          <div class="center_prod_box_big">
            <!-- Big Pic-->
            <div class="product_img_big"> <a href="javascript:popImage('images/p2a.png','Some Title')" title="header=[Zoom] body=[&nbsp;] fade=[on]"><img src="images/p2.gif" alt="" border="0" width="90" height="92" /></a>
              <div class="thumbs"> <a href="#" title="header=[Thumb1] body=[&nbsp;] fade=[on]"><img src="images/AppleW1.PNG" alt="" border="0" width="30" height="30" /></a> <a href="#" title="header=[Thumb2] body=[&nbsp;] fade=[on]"><img src="images/AppleW2.PNG" alt="" border="0" width="30" height="30" /></a> <a href="#" title="header=[Thumb3] body=[&nbsp;] fade=[on]"><img src="images/AppleW3.PNG" alt="" border="0" width="30" height="30" /></a> </div>
            </div>
            <div class="details_big_box">
              <div class="product_title_big">Apple Watch Series 6 (GPS, 44mm) - Space Grey Aluminium Case with Black Sport Band</div>
              <div class="specifications"> Availability: <span class="blue">In stock</span><br />
                Warrenty: <span class="blue">24 months</span><br />
                Type: <span class="blue">Smart Watch</span><br />
                includes <span class="blue">USB-C to Lightning Cable, Band. </span><br />
              </div>
              <div class="prod_price_big"><span class="reduce">499$</span> <span class="price">449$</span></div>
        ...
        <div class="prod_box">
          ...
          <div class="center_prod_box">
            <div class="product_title"><a href="Asus%20Laptop.php">Asus TUF FX505GT-AB73</a></div>
            <div class="product_img"><a href="Asus%20Laptop.php"><img src="images/laptop.gif" alt="" border="0" width="100" height="98" /></a></div>
            <div class="prod_price"><span class="reduce">350$</span> <span class="price">270$</span></div>
          </div>

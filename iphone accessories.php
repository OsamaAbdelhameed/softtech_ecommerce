...
if (isset($_POST['addtocart']) || isset($_POST['removefromcart'])) {
  if (isset($_SESSION['quantity'])) {
    $sql = "SELECT * FROM Item where id ='6'";
    ...
    <div id="header">
      ...
      <div class="oferte_content">
        ...
        <div class="oferta">
          ...
          <div class="oferta_content"> <img src="images/case 1.jpeg" alt="" border="0" width="90" height="92" class="oferta_img" />
            <div class="oferta_details">
              <div class="oferta_title">
                iphone 12 pro back case</div>
              <div class="oferta_text">
                back portective case contains a safe small pocket for cards </div>
              <a href="iphone%20accessories.php" class="details"> &nbsp Refresh</a>
            </div>
          </div>
          <div class="oferta_pagination"> <a href="iphone%20accessories.php"><span class="current">1</span></a> <a href="#">2</a> <a href="#">3</a> <a href="#">4</a> <a href="#">5</a> </div>
        </div>
        <div class="top_divider"><img src="images/header_divider.png" alt="" width="1" height="164" /></div>
      </div>
    ...
    <div id="main_content">
      ...
      <div class="left_content">
        ...
        <div class="border_box">
          ...
          <div class="product_img"><a href="Asus%20Laptop.phph"><img src="images/laptop.png" alt="" border="0" width="100" height="98" /></a></div>
      ...
      <div class="center_content">
        ...
        <div class="prod_box_big">
          ...
          <div class="center_prod_box_big">
            <!-- Big Pic-->
            <div class="product_img_big"> <a href="javascript:popImage('images/case 1.jpeg','Some Title')" title="header=[Zoom] body=[&nbsp;] fade=[on]"><img src="images/case 1.jpeg" alt="" border="0" width="180" height="100" /></a>
              <div class="thumbs"> <a href="#" title="header=[Thumb2] body=[&nbsp;] fade=[on]"><img src="images/case 3.jpeg" alt="" border="0" width="40" height="40" /></a> <a href="#" title="header=[Thumb3] body=[&nbsp;] fade=[on]"><img src="images/case 4.jpeg" alt="" border="0" width="40" height="40" /></a> <a href="#" title="header=[Thumb3] body=[&nbsp;] fade=[on]"><img src="images/case 5.jpeg" alt="" border="0" width="40" height="40" /></a> </div>
            </div>
            <div class="details_big_box">
              <div class="product_title_big">iphone 12 pro back case</div>
              <div class="specifications"> Availability: <span class="blue">In stock</span><br />
                Warrenty: <span class="blue">5 months</span><br />
                Type: <span class="blue">protection</span><br />
                includes <span class="blue">back cover</span><br />
              </div>
              <div class="prod_price_big"><span class="reduce">30$</span> <span class="price">20$</span></div>

...
if (isset($_POST['addtocart']) || isset($_POST['removefromcart'])) {
  if (isset($_SESSION['quantity'])) {
    $sql = "SELECT * FROM Item where id ='7'";
    ...
    <div id="header">
      ...
      <div class="oferte_content">
        ...
        <div class="oferta">
          ...
          <div class="oferta_content"> <img src="images/strap 0.jpeg" alt="" border="0" width="100" height="90" class="oferta_img" />
            <div class="oferta_details">
              <div class="oferta_title">
                apple watch strap</div>
              <div class="oferta_text">
                new classic strap for apple watch </div>
              <a href="watch%20strap.php" class="details"> &nbsp Refresh</a>
            </div>
          </div>
          <div class="oferta_pagination"> <a href="watch%20strap.php"><span class="current">1</span></a> <a href="#">2</a> <a href="#">3</a> <a href="#">4</a> <a href="#">5</a> </div>
        </div>
        <div class="top_divider"><img src="images/header_divider.png" alt="" width="1" height="164" /></div>
      </div>
    ...
    <div id="main_content">
      ...
      <div class="left_content">
        ...
        <div class="border_box">
          ...
          <div class="product_img"><a href="Asus%20Laptop.php"><img src="images/laptop.png" alt="" border="0" width="100" height="98" /></a></div>
      ...
      <div class="center_content">
        ...
        <div class="prod_box_big">
          ...
          <div class="center_prod_box_big">
            <!-- Big Pic-->
            <div class="product_img_big"> <a href="javascript:popImage('images/strap 0 .gif','Some Title')" title="header=[Zoom] body=[&nbsp;] fade=[on]"><img src="images/strap 0.jpeg" alt="" border="0" width="150" height="100" /></a>
              <div class="thumbs"> <a href="#" title="header=[Thumb1] body=[&nbsp;] fade=[on]"><img src="images/strap 1.jpeg" alt="" border="0" width="40" height="40" /></a> <a href="#" title="header=[Thumb2] body=[&nbsp;] fade=[on]"><img src="images/strap 2.jpeg" alt="" border="0" width="40" height="40" /></a> <a href="#" title="header=[Thumb3] body=[&nbsp;] fade=[on]"><img src="images/strap 3.jpeg" alt="" border="0" width="40" height="40" /></a> <a href="#" title="header=[Thumb4] body=[&nbsp;] fade=[on]"><img src="images/strap 4.jpeg" alt="" border="0" width="30" height="30" /></a> </div>
            </div>
            <div class="details_big_box">
              <div class="product_title_big">apple watch strap</div>
              <div class="specifications"> Availability: <span class="blue">In stock</span><br />
                Warrenty: <span class="blue">2 months</span><br />
                Type: <span class="blue">strap</span><br />
                includes <span class="blue">Classic strap</span><br />
              </div>
              <div class="prod_price_big"><span class="reduce">70$</span> <span class="price">50$</span></div>
        ...
        <div class="prod_box">
          ...
          <div class="center_prod_box">
            <div class="product_title"><a href="iphone%20accessories.php">iphone 12 pro back case</a></div>
            <div class="product_img"><a href="iphone%20accessories.php"><img src="images/case 1.jpeg" alt="" border="0" width="130" height="98" /></a></div>
            <div class="prod_price"><span class="reduce">30$</span> <span class="price">20$</span></div>
          </div>
          <div class="bottom_prod_box"></div>
          <div class="prod_details_tab"> <a href="#" title="header=[Add to cart] body=[&nbsp;] fade=[on]"><img src="images/cart.gif" alt="" border="0" class="left_bt" /></a> <a href="#" title="header=[Specials] body=[&nbsp;] fade=[on]"><img src="images/favs.gif" alt="" border="0" class="left_bt" /></a> <a href="#" title="header=[Gifts] body=[&nbsp;] fade=[on]"><img src="images/favorites.gif" alt="" border="0" class="left_bt" /></a> <a href="iphone%20accessories.html#" class="prod_details">details</a> </div>
        </div>
        <div class="prod_box">
          <div class="top_prod_box"></div>
          <div class="center_prod_box">
            <div class="product_title"><a href="Iphone12.php">Apple iPhone 12 Pro (128GB) - Pacific Blue</a></div>
            <div class="product_img"><a href="Iphone12.php"><img src="images/p4.gif" alt="" border="0" width="72" height="92" /></a></div>
        ...
        <div class="prod_box">
          ...
          <div class="center_prod_box">
            ...
            <div class="product_img"><a href="Samsung_S21.php"><img src="images/p5.gif" alt="" border="0" width="90" height="92" /></a></div>
      ...
      <div class="right_content">
        ...
        <div class="border_box">
          ...
          <div class="product_img"><a href="AppleWatch.php"><img src="images/p2.gif" alt="" border="0" width="90" height="92" /></a></div>

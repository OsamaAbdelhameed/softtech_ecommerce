...
if (isset($_POST['addtocart']) || isset($_POST['removefromcart'])) {
  if (isset($_SESSION['quantity'])) {
    $sql = "SELECT * FROM Item where id ='4'";
...
<head>
  <title>Apple iphone 12 details</title>
...
<body>
  <div id="main_container">
    ...
    <div id="header">
      ...
      <div class="oferte_content">
        ...
        <div class="oferta">
          ...
          <div class="oferta_content"> <img src="images/p4.gif" alt="" border="0" width="72" height="92" class="oferta_img" />
            <div class="oferta_details">
              <div class="oferta_title">Apple iPhone 12 Pro (128GB) - Pacific Blue</div>
              <div class="oferta_text"> Apple iPhone 12 Pro (128GB) - Pacific Blue, Night Mode Time-lapse, 2X Optical Zoom, Dual Optical Image Stabilization, Rear: 12 MP + 12 MP + 12 MP/Front: 12 MP, WiFi/Bluetooth, 2532 X 1170 Pixels.</div>
              <a href="Iphone12.php" class="details"> &nbsp Refresh</a>
            </div>
          </div>
          <div class="oferta_pagination"> <a href="Iphone12.php"><span class="current">1</span></a> <a href="Samsung_S21.php">2</a> <a href="#">3</a> <a href="#">4</a> <a href="#">5</a> </div>
        </div>
        <div class="top_divider"><img src="images/header_divider.png" alt="" width="1" height="164" /></div>
      </div>
    ...
    <div id="main_content">
      ...
      <!-- end of menu tab -->
      <!-- nav -->
      <div class="crumb_navigation"> Navigation: <a href="index.php">Home</a> &lt; <span class="current">Electronic Devices &lt; Apple iPhone 12 Pro (128GB)</span> </div>
      ...
      <div class="center_content">
        <div class="center_title_bar">Apple iPhone 12 Pro (128GB) - Pacific Blue</div>
        <div class="prod_box_big">
          <div class="top_prod_box_big"></div>
          <div class="center_prod_box_big">
            <!-- Big Pic-->
            <div class="product_img_big"> <a href="javascript:popImage('images/iphone.png','Some Title')" title="header=[Zoom] body=[&nbsp;] fade=[on]"><img src="images/p4.gif" alt="" border="0" width="72" height="92" /></a>
              <div class="thumbs"> <a href="#" title="header=[Thumb1] body=[&nbsp;] fade=[on]"><img src="images/iphone1.PNG" alt="" border="0" width="30" height="30" /></a> <a href="#" title="header=[Thumb2] body=[&nbsp;] fade=[on]"><img src="images/iphone2.PNG" alt="" border="0" width="30" height="30" /></a> <a href="#" title="header=[Thumb3] body=[&nbsp;] fade=[on]"><img src="images/iphone3.PNG" alt="" border="0" width="30" height="30" /></a> </div>
            </div>
            <div class="details_big_box">
              <div class="product_title_big">Apple iPhone 12 Pro (128GB) - Pacific Blue</div>
              <div class="specifications"> Availability: <span class="blue">In stock</span><br />
                Warrenty: <span class="blue">24 months</span><br />
                Type: <span class="blue">Smart Phone</span><br />
                includes <span class="blue">USB-C to Lightning Cable. </span><br />
              </div>
              <div class="prod_price_big"><span class="reduce"></span> <span class="price">899$</span></div>

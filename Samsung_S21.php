...
if (isset($_POST['addtocart']) || isset($_POST['removefromcart'])) {
    if (isset($_SESSION['quantity'])) {
        $sql = "SELECT * FROM Item where id ='5'";
...
<head>
    <title>
        Samsung Galaxy S21 details</title>
...
<body>
    <div id="main_container">
        ...
        <div id="header">
            <div id="logo">
                <a href="#"><img src="images/logo.png" alt="" border="0" width="237" height="140" /></a>
            </div>
            <div class="oferte_content">
                <div class="top_divider"><img src="images/header_divider.png" alt="" width="1" height="164" /></div>
                <div class="oferta">
                    <!--Main image of the product-->
                    <div class="oferta_content"> <img src="images/p5.gif" alt="" border="0" width="90" height="92" class="oferta_img" />
                        <div class="oferta_details">
                            <div class="oferta_title">
                                Samsung Galaxy S21 5G</div>
                            <div class="oferta_text">
                                Samsung Galaxy S21 5G - Black, Samsung Galaxy S21 Dual SIM - 128GB, 8GB RAM, 5G, Infinity-O Dynamic AMOLED 2x Display, 4000mAh battery with Fast Charging, 64MP telephoto, 12MP ultrawide, 12MP wide, and a 10MP front.</div>
                            <a href="Samsung_S21.html" class="details"> &nbsp Refresh</a>
                        </div>
                    </div>
                    <div class="oferta_pagination"> <a href="Iphone12.php">1</a><a href="Samsung_S21.php"><span class="current">2</span></a> <a href="#">3</a> <a href="#">4</a> <a href="#">5</a> </div>
                </div>
                <div class="top_divider"><img src="images/header_divider.png" alt="" width="1" height="164" /></div>
            </div>
        ...
        <div id="main_content">
            ...
            <!-- end of menu tab -->
            <!-- nav -->
            <div class="crumb_navigation"> Navigation: <a href="index.php">Home</a> &lt; <span class="current">Electronic Devices &lt; Samsung Galaxy S21 5G</span> </div>
            ...
            <div class="center_content">
                <div class="center_title_bar">Samsung Galaxy S21 5G</div>
                <div class="prod_box_big">
                    <div class="top_prod_box_big"></div>
                    <div class="center_prod_box_big">
                        <!-- Big Pic-->
                        <div class="product_img_big">
                            <a href="javascript:popImage('images/p5.gif','Some Title')" title="header=[Zoom] body=[&nbsp;] fade=[on]"><img src="images/p5.gif" alt="" border="0" width="90" height="92" /></a>
                            <div class="thumbs">
                                <a href="#" title="header=[Thumb1] body=[&nbsp;] fade=[on]"><img src="images/s21_1.PNG" alt="" border="0" width="30" height="30" /></a>
                                <a href="#" title="header=[Thumb2] body=[&nbsp;] fade=[on]"><img src="images/s21_2.PNG" alt="" border="0" width="30" height="30" /></a>
                                <a href="#" title="header=[Thumb3] body=[&nbsp;] fade=[on]"><img src="images/s21_3.PNG" alt="" border="0" width="30" height="30" /></a>
                            </div>
                        </div>
                        <div class="details_big_box">
                            <div class="product_title_big">Samsung Galaxy S21 5G - Black</div>
                            <div class="specifications"> Availability: <span class="blue">In stock</span><br /> Warrenty: <span class="blue">24 months</span><br /> Type: <span class="blue">Smart Phone</span><br /> includes <span class="blue">USB-C to Lightning Cable, Sim card pin. </span><br />
                            </div>
                            <div class="prod_price_big"><span class="reduce">810$</span> <span class="price">720$</span></div>
                ...
                <div class="prod_box">
                    ...
                    <div class="center_prod_box">
                        <div class="product_title"><a href="Asus%20Laptop.php">Asus TUF FX505GT-AB73</a></div>
                        <div class="product_img">
                            <a href="Asus%20Laptop.php"><img src="images/laptop.gif" alt="" border="0" width="100" height="98" /></a>
                        </div>
                        <div class="prod_price"><span class="reduce">350$</span> <span class="price">270$</span></div>
                    </div>
                    ...
                    <div class="prod_details_tab">
                        ...
                        <a href="#" title="header=[Gifts] body=[&nbsp;] fade=[on]"><img src="images/favorites.gif" alt="" border="0" class="left_bt" /></a> <a href="Asus%20Laptop.html" class="prod_details">details</a>
                    </div>
                </div>
                <div class="prod_box">
                    <div class="top_prod_box"></div>
                    <div class="center_prod_box">
                        <div class="product_title"><a href="Iphone12.php">Apple iPhone 12 Pro (128GB) - Pacific Blue</a></div>
                        <div class="product_img">
                            <a href="Iphone12.php"><img src="images/p4.gif" alt="" border="0" width="72" height="92" /></a>
                        </div>
                    ...
                    <div class="prod_details_tab">
                        <a href="#" title="header=[Add to cart] body=[&nbsp;] fade=[on]"><img src="images/cart.gif" alt="" border="0" class="left_bt" /></a>
                        <a href="#" title="header=[Specials] body=[&nbsp;] fade=[on]"><img src="images/favs.gif" alt="" border="0" class="left_bt" /></a>
                        <a href="#" title="header=[Gifts] body=[&nbsp;] fade=[on]"><img src="images/favorites.gif" alt="" border="0" class="left_bt" /></a> <a href="Iphone12.html" class="prod_details">details</a>
                    </div>
                </div>
                <div class="prod_box">
                    <div class="top_prod_box"></div>
                    <div class="center_prod_box">
                        <div class="product_title"><a href="Samsung_S21.php">Samsung Galaxy S21 5G</a></div>
                        <div class="product_img">
                            <a href="Samsung_S21.php"><img src="images/p5.gif" alt="" border="0" width="90" height="92" /></a>
                        </div>
                    ...
                    <div class="prod_details_tab">
                        <a href="#" title="header=[Add to cart] body=[&nbsp;] fade=[on]"><img src="images/cart.gif" alt="" border="0" class="left_bt" /></a>
                        <a href="#" title="header=[Specials] body=[&nbsp;] fade=[on]"><img src="images/favs.gif" alt="" border="0" class="left_bt" /></a>
                        <a href="#" title="header=[Gifts] body=[&nbsp;] fade=[on]"><img src="images/favorites.gif" alt="" border="0" class="left_bt" /></a> <a href="Samsung_S21.html" class="prod_details">details</a>
                    </div>
                </div>
            </div>
